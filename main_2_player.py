...
if __name__ == "__main__":
    ...
    # player 1
    controller_p1 = DistanceController(game_state=game_state, snake_player=game_state.snake_player_1)
    input_direction_p1 = game_state.snake_player_1.curr_direction

    # player 2
    if game_state.is_2_player:
        controller_p2 = DistanceController(game_state=game_state, snake_player=game_state.snake_player_2)
        input_direction_p2 = game_state.snake_player_2.curr_direction
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_UP:
                    input_direction_p1 = Direction.UP
                if event.key == pygame.K_DOWN:
                    input_direction_p1 = Direction.DOWN
                if event.key == pygame.K_LEFT:
                    input_direction_p1 = Direction.LEFT
                if event.key == pygame.K_RIGHT:
                    input_direction_p1 = Direction.RIGHT

        # player 1
        input_direction_p1 = controller_p1.compute_next_direction()
        # player 2
        if game_state.is_2_player:
            input_direction_p2 = controller_p2.compute_next_direction()

        # * Game Logic
        # player 1
        game_state.snake_make_next_move(snake_player=game_state.snake_player_1, input_direction=input_direction_p1)

        # player 2
        if game_state.is_2_player:
            game_state.snake_make_next_move(snake_player=game_state.snake_player_2, input_direction=input_direction_p2)
        ...
        # player 1
        # render snake tail
        for coord in game_state.snake_player_1.tail_coords:
        ...
        snake_head_coord = game_state.snake_player_1.head_coord
        # render snake head
        ...
        # player 2
        if game_state.is_2_player:
            for coord in game_state.snake_player_2.tail_coords:
                pygame.draw.rect(GAME_WINDOM, BLUE_CLR,
                                pygame.Rect(coord[1] * RENDER_BLOCK_SIZE, coord[0] * RENDER_BLOCK_SIZE, RENDER_BLOCK_SIZE, RENDER_BLOCK_SIZE))
            snake_head_coord = game_state.snake_player_2.head_coord
            # render snake head
            pygame.draw.rect(GAME_WINDOM, RED_CLR,
                            pygame.Rect(snake_head_coord[1] * RENDER_BLOCK_SIZE, snake_head_coord[0] * RENDER_BLOCK_SIZE, RENDER_BLOCK_SIZE, RENDER_BLOCK_SIZE))
        # render fruit
